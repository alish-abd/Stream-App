...
//  Stream
//
//  Created by Alisher Abdulin on 09.01.2023.
//
...
final class StorageManager {
    ...
    public func uploadUserProfilePicture(
        ...
        container
            .reference(withPath: "profile_picture/\(path)/photo.png")
    ...
    public func uploadBlogHeaderImage(
        ...
        container
            .reference(withPath: "posts_headers/\(path)/\(postId).png")
            .putData(pngData, metadata: nil) { metadata, error in
                guard metadata != nil, error == nil else {
                    completion(false)
                    return
    ...
    public func downloadUrlForPostHeader(
        ...
        let emailComponent = email
            ...
            .replacingOccurrences(of: ".", with: "_")
        container
            .reference(withPath: "posts_headers/\(emailComponent)/\(postId).png")
